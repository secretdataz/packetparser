...
function PACKET_AC_ACCEPT_LOGIN($parser) {
	...
	echo "$parser->nl userLevel=".$parser->long()."\n";
	echo "$parser->nl lastLoginIP=".$parser->long()."\n";
...
function PACKET_CZ_REQUEST_MOVENPC($parser) {
	echo "$parser->packet_desc GID=".$parser->long()."\n";
	echo "$parser->nl dest=".$parser->string(3)."\n";
}
...
function PACKET_ZC_SE_CASHSHOP_OPEN($parser) {
	echo "$parser->packet_desc cash_point=".$parser->long()."\n";
}

// packet 0x846
function PACKET_CZ_REQ_SE_CASH_TAB_CODE($parser) {
	echo "$parser->packet_desc tab_code=".$parser->word()."\n";
}

// packet 0x847
function PACKET_ZC_ACK_SE_CASH_ITEM_LIST($parser) {
	echo "$parser->packet_desc PacketLength=".$parser->word()."\n";
	echo "$parser->nl item_count=".$parser->word()."\n";
	$items = ($parser->packet_length - $parser->packet_pointer) / 8;
	for ($i = 0; $i < $items; $i++) {
		echo "$parser->nl item_id=".$parser->long()."\n";
		echo "$parser->nl price=".$parser->long()."\n";
	}
}
...
function PACKET_CZ_SE_PC_BUY_CASHITEM_LIST($parser) {
	...
	for ($i = 0; $i < $items; $i++) {
		echo "$parser->nl item_id=".$parser->long()."\n";
		echo "$parser->nl count=".$parser->long()."\n";
		echo "$parser->nl tab_code=".$parser->word()."\n";
	}
}

// packet 0x849
function PACKET_ZC_SE_PC_BUY_CASHITEM_RESULT($parser) {
	echo "$parser->packet_desc item_id=".$parser->long()."\n";
	echo "$parser->nl result=".$parser->word()."\n";
}
...
function PACKET_CZ_MACRO_USE_SKILL($parser) {
	echo "$parser->packet_desc SKID=".$parser->word()."\n";
	echo "$parser->nl selectedLevel=".$parser->word()."\n";
	echo "$parser->nl targetID=".$parser->long()."\n";
}
...
function PACKET_CZ_MACRO_REQUEST_ACT($parser) {
	echo "$parser->packet_desc action=".$parser->byte()."\n";
	echo "$parser->nl targetGID=".$parser->long()."\n";
}
...
function PACKET_ZC_ACK_SE_CASH_ITEM_LIST2($parser) {
	echo "$parser->packet_desc PacketLength=".$parser->word()."\n";
	echo "$parser->nl OpenIdentity=".$parser->long()."\n";
	echo "$parser->nl item_count=".$parser->word()."\n";
	$ItemList = ($parser->packet_length - $parser->packet_pointer) / 6;
	for ($i = 0; $i < $ItemList; $i++) {
		echo "$parser->nl item_id=".$parser->word()."\n";
		echo "$parser->nl price=".$parser->long()."\n";
	}
}
...
function PACKET_CH_NOT_AVAILABLE_SECOND_PASSWD($parser) {
	echo "$parser->packet_desc AID=".$parser->long()."\n";
	echo "$parser->nl SecondPWIdx=".$parser->string(4)."\n";
}
...
function PACKET_ZC_SKILL_ENTRY3($parser) {
	...
	echo "$parser->nl yPos=".$parser->word()."\n";
	echo "$parser->nl job=".$parser->byte()."\n";
	echo "$parser->nl RadiusRange=".$parser->byte()."\n";
	echo "$parser->nl isVisible=".$parser->byte()."\n";
}
...
function PACKET_ZC_NOTIFY_ACT3($parser) {
	...
	echo "$parser->nl attackedMT=".$parser->long()."\n";
	echo "$parser->nl damage=".$parser->long()."\n";
	echo "$parser->nl IsSPDamage=".$parser->byte()."\n";
	echo "$parser->nl count=".$parser->word()."\n";
	echo "$parser->nl action=".$parser->byte()."\n";
	echo "$parser->nl leftDamage=".$parser->long()."\n";
}
...
function PACKET_ZC_PERSONAL_INFOMATION($parser) {
	echo "$parser->packet_desc PacketLength=".$parser->word()."\n";
	echo "$parser->nl Exp=".$parser->word()."\n";
	echo "$parser->nl Death=".$parser->word()."\n";
	echo "$parser->nl Drop=".$parser->word()."\n";
	$DetailInfo = ($parser->packet_length - $parser->packet_pointer) / 6;
	for ($i = 0; $i < $DetailInfo; $i++) {
		echo "$parser->nl InfoType=".$parser->byte()."\n";
		echo "$parser->nl Exp=".$parser->word()."\n";
		echo "$parser->nl Death=".$parser->word()."\n";
		echo "$parser->nl Drop=".$parser->word()."\n";
	}
...
function PACKET_CA_LOGIN5($parser) {
	echo "$parser->packet_desc Version=".$parser->long()."\n";
	echo "$parser->nl ID=".$parser->string(51)."\n";
	echo "$parser->nl Passwd=".$parser->string(51)."\n";
	echo "$parser->nl clienttype=".$parser->byte()."\n";
}
...
function PACKET_ZC_SPIRITS_ATTRIBUTE($parser) {
	echo "$parser->packet_desc AID=".$parser->long()."\n";
	echo "$parser->nl SpritsType=".$parser->word()."\n";
	echo "$parser->nl Num=".$parser->word()."\n";
}
...
function PACKET_ZC_SE_CASHSHOP_UPDATE($parser) {
	echo "$parser->packet_desc cash_point=".$parser->long()."\n";
	echo "$parser->nl free_point=".$parser->long()."\n";
}

// packet 0x8d4
function PACKET_CH_REQ_CHANGE_CHARACTER_SLOT($parser) {
	echo "$parser->packet_desc beforeCharNum=".$parser->word()."\n";
	echo "$parser->nl AfterCharNum=".$parser->word()."\n";
	echo "$parser->nl CurChrSlotCnt=".$parser->word()."\n";
}

// packet 0x8d5
function PACKET_HC_ACK_CHANGE_CHARACTER_SLOT($parser) {
	echo "$parser->packet_desc PacketLength=".$parser->word()."\n";
	echo "$parser->nl Reason=".$parser->word()."\n";
	echo "$parser->nl AfterChrSlotCnt=".$parser->word()."\n";
}
...
function PACKET_CZ_REQ_ENTRY_QUEUE_APPLY($parser) {
	echo "$parser->packet_desc ApplyType=".$parser->word()."\n";
	echo "$parser->nl EntryQueueName=".$parser->string(24)."\n";
}
...
function PACKET_ZC_NOTIFY_ENTRY_QUEUE_APPLY($parser) {
	echo "$parser->packet_desc EntryQueueName=".$parser->string(24)."\n";
	echo "$parser->nl Ranking=".$parser->long()."\n";
}
...
function PACKET_ZC_NOTIFY_LOBBY_ADMISSION($parser) {
	echo "$parser->packet_desc EntryQueueName=".$parser->string(24)."\n";
	echo "$parser->nl LobbyName=".$parser->string(24)."\n";
}
...
function PACKET_ZC_NAVIGATION_ACTIVE($parser) {
	echo "$parser->packet_desc Type=".$parser->byte()."\n";
	echo "$parser->nl SetType=".$parser->byte()."\n";
	echo "$parser->nl Hide=".$parser->byte()."\n";
	echo "$parser->nl MapName=".$parser->string(16)."\n";
	echo "$parser->nl xPos=".$parser->word()."\n";
	echo "$parser->nl yPos=".$parser->word()."\n";
	echo "$parser->nl sprIndex=".$parser->word()."\n";
}
...
function PACKET_CZ_PARTY_RECRUIT_REQ_REGISTER($parser) {
	...
	for ($i = 0; $i < $regsiterInfo; $i++) {
		echo "$parser->nl Level=".$parser->word()."\n";
		echo "$parser->nl Notice=".$parser->string(37)."\n";
	}
}
...
function PACKET_CZ_PARTY_RECRUIT_REQ_UPDATE($parser) {
	echo "$parser->packet_desc Notice=".$parser->string(37)."\n";
}
...
function PACKET_ZC_PARTY_RECRUIT_RECALL_COST($parser) {
	echo "$parser->packet_desc Money=".$parser->long()."\n";
	echo "$parser->nl mapName=".$parser->string(16)."\n";
}
...
function PACKET_ZC_PARTY_RECRUIT_FAILED_RECALL($parser) {
	echo "$parser->packet_desc CallerAID=".$parser->long()."\n";
	echo "$parser->nl Reason=".$parser->byte()."\n";
}

// packet 0x8f9
function PACKET_CZ_PARTY_RECRUIT_REFUSE_VOLUNTEER($parser) {
	echo "$parser->packet_desc REFUSE_AID=".$parser->long()."\n";
}
...
function PACKET_HC_ACK_CHANGE_CHARACTERNAME($parser) {
	echo "$parser->packet_desc dwResult=".$parser->long()."\n";
}

// packet 0x8ff
function PACKET_ZC_EFST_SET_ENTER($parser) {
	echo "$parser->packet_desc AID=".$parser->long()."\n";
	echo "$parser->nl hEFST=".$parser->word()."\n";
	echo "$parser->nl Time=".$parser->long()."\n";
	echo "$parser->nl Val1=".$parser->long()."\n";
	echo "$parser->nl Val2=".$parser->long()."\n";
	echo "$parser->nl Val3=".$parser->long()."\n";
}
...
function PACKET_ZC_INVENTORY_ITEMLIST_NORMAL($parser) {
	...
	for ($i = 0; $i < $Items; $i++) {
		...
		echo "$parser->nl card4=".$parser->word()."\n";
		echo "$parser->nl HireExpireDate=".$parser->long()."\n";
		echo "$parser->nl Flag=".$parser->byte()."\n";
	}
}
...
function PACKET_CZ_INVENTORY_TAB($parser) {
	echo "$parser->packet_desc Index=".$parser->word()."\n";
	echo "$parser->nl NORMALorPRIVATE=".$parser->byte()."\n";
}
...
function PACKET_ZC_PREMIUM_CAMPAIGN_INFO($parser) {
	echo "$parser->packet_desc PacketLength=".$parser->word()."\n";
	echo "$parser->nl Count=".$parser->word()."\n";
	echo "$parser->nl PremiumValue=".$parser->long()."\n";
	$CampainInfo = ($parser->packet_length - $parser->packet_pointer) / 14;
	for ($i = 0; $i < $CampainInfo; $i++) {
		echo "$parser->nl Grade=".$parser->word()."\n";
		echo "$parser->nl Exp=".$parser->long()."\n";
		echo "$parser->nl Death=".$parser->long()."\n";
		echo "$parser->nl Drp=".$parser->long()."\n";
	}
}
...
function PACKET_ZC_NOTIFY_NEWENTRY7($parser) {
	...
	echo "$parser->nl maxHP=".$parser->long()."\n";
	echo "$parser->nl HP=".$parser->long()."\n";
	echo "$parser->nl isBoss=".$parser->byte()."\n";
}

// packet 0x910
function PACKET_CZ_REQ_PARTY_NAME($parser) {
	echo "$parser->packet_desc AID=".$parser->long()."\n";
	echo "$parser->nl PartyID=".$parser->long()."\n";
}

// packet 0x911
function PACKET_ZC_ACK_PARTY_NAME($parser) {
	echo "$parser->packet_desc PartyID=".$parser->long()."\n";
	echo "$parser->nl szPartyName=".$parser->string(24)."\n";
}

// packet 0x912
function PACKET_CZ_REQ_GUILD_NAME($parser) {
	echo "$parser->packet_desc AID=".$parser->long()."\n";
	echo "$parser->nl GuildID=".$parser->long()."\n";
}
...
function PACKET_ZC_PRNPC_STATE($parser) {
	echo "$parser->packet_desc Winner=".$parser->byte()."\n";
	echo "$parser->nl Point=".$parser->byte()."\n";
}
...
function PACKET_ZC_ACK_MERGE_ITEM($parser) {
	echo "$parser->packet_desc item_index=".$parser->word()."\n";
	echo "$parser->nl item_count=".$parser->word()."\n";
	echo "$parser->nl Result=".$parser->byte()."\n";
}
...
function PACKET_ZC_PARTY_RECRUIT_REFUSE_VOLUNTEER_TO_PM($parser) {
	echo "$parser->packet_desc PM_AID=".$parser->long()."\n";
}
...
function PACKET_ZC_ACK_BEFORE_WORLD_INFO($parser) {
	echo "$parser->packet_desc WorldName=".$parser->string(24)."\n";
	echo "$parser->nl CharName=".$parser->string(24)."\n";
}
...
function PACKET_ZC_PERSONAL_INFOMATION2($parser) {
	...
	echo "$parser->nl Exp=".$parser->long()."\n";
	echo "$parser->nl Death=".$parser->long()."\n";
	echo "$parser->nl Drop=".$parser->long()."\n";
...
function PACKET_CZ_REQ_RANKING($parser) {
	echo "$parser->packet_desc RankingType=".$parser->word()."\n";
}
...
function PACKET_ZC_ACK_RANKING($parser) {
	...
	echo "$parser->nl CharName=".$parser->string(24)."\n";
	echo "$parser->nl Point=".$parser->long()."\n";
	echo "$parser->nl myPoint=".$parser->long()."\n";
}
...
function PACKET_CZ_SELECTCART($parser) {
	echo "$parser->packet_desc Identity=".$parser->long()."\n";
	echo "$parser->nl type=".$parser->byte()."\n";
}
...
function PACKET_ZC_PERSONAL_INFOMATION_CHN($parser) {
	...
	echo "$parser->nl Death=".$parser->word()."\n";
	echo "$parser->nl Drop=".$parser->word()."\n";
	echo "$parser->nl ActivityRate=".$parser->word()."\n";
	$DatailInfo = ($parser->packet_length - $parser->packet_pointer) / 13;
	for ($i = 0; $i < $DatailInfo; $i++) {
		echo "$parser->nl InfoType=".$parser->byte()."\n";
		echo "$parser->nl Exp=".$parser->long()."\n";
...
function PACKET_ZC_FATIGUE_CHN($parser) {
	echo "$parser->packet_desc Level=".$parser->byte()."\n";
	echo "$parser->nl TotalPlayTime=".$parser->long()."\n";
}
...
function PACKET_ZC_MSG_STATE_CHANGE3($parser) {
	...
	echo "$parser->nl AID=".$parser->long()."\n";
	echo "$parser->nl state=".$parser->byte()."\n";
	echo "$parser->nl MaxMS=".$parser->long()."\n";
	echo "$parser->nl RemainMS=".$parser->long()."\n";
	echo "$parser->nl val=".$parser->long()."\n";
}
...
function PACKET_ZC_SKILL_POSTDELAY_LIST2($parser) {
	...
	for ($i = 0; $i < $PostDelay; $i++) {
		echo "$parser->nl SKID=".$parser->word()."\n";
		echo "$parser->nl MaxDelayTM=".$parser->long()."\n";
		echo "$parser->nl DelayTM=".$parser->long()."\n";
	}
}
...
function PACKET_AC_SHUTDOWN_NOTIFY($parser) {
	echo "$parser->packet_desc Time=".$parser->long()."\n";
	echo "$parser->nl ServerTime=".$parser->long()."\n";
}
...
function PACKET_CA_LOGIN6($parser) {
	echo "$parser->packet_desc Version=".$parser->long()."\n";
	echo "$parser->nl ID=".$parser->string(24)."\n";
	echo "$parser->nl PasswdMD5=".$parser->string(32)."\n";
	echo "$parser->nl clienttype=".$parser->byte()."\n";
}

// packet 0x988
function PACKET_ZC_NOTIFY_CLAN_CONNECTINFO($parser) {
	echo "$parser->packet_desc NumConnect=".$parser->word()."\n";
	echo "$parser->nl NumTotal=".$parser->word()."\n";
}
...
function PACKET_ZC_CLANINFO($parser) {
	echo "$parser->packet_desc PacketLength=".$parser->word()."\n";
	echo "$parser->nl EmblemNum=".$parser->long()."\n";
	echo "$parser->nl ClanName=".$parser->string(24)."\n";
	echo "$parser->nl Mastername=".$parser->string(24)."\n";
	echo "$parser->nl ManageMap=".$parser->string(16)."\n";
	echo "$parser->nl Num_AllyClan=".$parser->byte()."\n";
	echo "$parser->nl Num_HostileClan=".$parser->byte()."\n";
}
...
function PACKET_CZ_CLAN_CHAT($parser) {
	echo "$parser->packet_desc PacketLength=".$parser->word()."\n";
	echo "$parser->nl chat=".$parser->string($parser->packet_length - $parser->packet_pointer)."\n";
}
...
function PACKET_ZC_ITEM_PICKUP_ACK_V5($parser) {
	...
	echo "$parser->nl refiningLevel=".$parser->byte()."\n";
		...
		echo "$parser->nl card3=".$parser->word()."\n";
		echo "$parser->nl card4=".$parser->word()."\n";
	echo "$parser->nl location=".$parser->long()."\n";
	echo "$parser->nl type=".$parser->byte()."\n";
	echo "$parser->nl result=".$parser->byte()."\n";
	echo "$parser->nl HireExpireDate=".$parser->long()."\n";
	echo "$parser->nl bindOnEquipType=".$parser->word()."\n";
...
function PACKET_ZC_INVENTORY_ITEMLIST_NORMAL_V5($parser) {
	...
	for ($i = 0; $i < $Items; $i++) {
		...
		echo "$parser->nl type=".$parser->byte()."\n";
		echo "$parser->nl count=".$parser->word()."\n";
		echo "$parser->nl WearState=".$parser->long()."\n";
		echo "$parser->nl card1=".$parser->word()."\n";
		echo "$parser->nl card2=".$parser->word()."\n";
		echo "$parser->nl card3=".$parser->word()."\n";
		echo "$parser->nl card4=".$parser->word()."\n";
...
function PACKET_CZ_REQ_WEAR_EQUIP_V5($parser) {
	echo "$parser->packet_desc index=".$parser->word()."\n";
	echo "$parser->nl wearLocation=".$parser->long()."\n";
}
...
function PACKET_ZC_MAPPROPERTY_R2($parser) {
	echo "$parser->packet_desc type=".$parser->word()."\n";
	echo "$parser->nl NotifyPropertyBits=".$parser->long()."\n";
}

// packet 0x99c
function PACKET_CH_REQ_CHARINFO_PER_PAGE($parser) {
	echo "$parser->packet_desc SeqNum=".$parser->long()."\n";
}
...
function PACKET_HC_QUEUE_ORDER($parser) {
	echo "$parser->packet_desc PacketLength=".$parser->word()."\n";
	echo "$parser->nl m_AID=".$parser->long()."\n";
	echo "$parser->nl m_QueueOrder=".$parser->long()."\n";
}
...
function PACKET_HC_CHARLIST_NOTIFY($parser) {
	echo "$parser->packet_desc TotalCnt=".$parser->long()."\n";
}
...
function PACKET_ZC_DISPATCH_TIMING_INFO_CHN($parser) {
	echo "$parser->packet_desc AID=".$parser->long()."\n";
	echo "$parser->nl Balance=".$parser->long()."\n";
	echo "$parser->nl Effective_dTime=".$parser->long()."\n";
	echo "$parser->nl Reason=".$parser->long()."\n";
}

// packet 0x9a5
function PACKET_AC_REFUSE_LOGIN3($parser) {
	echo "$parser->packet_desc ErrorCode=".$parser->byte()."\n";
	echo "$parser->nl BlockedReaminSEC=".$parser->long()."\n";
}

// packet 0x9a6
function PACKET_ZC_BANKING_CHECK($parser) {
	echo "$parser->packet_desc Money=".$parser->int64()."\n";
	echo "$parser->nl Reason=".$parser->word()."\n";
}
...
function PACKET_ZC_ACK_BANKING_DEPOSIT($parser) {
	echo "$parser->packet_desc Reason=".$parser->word()."\n";
	echo "$parser->nl Money=".$parser->int64()."\n";
}
...
function PACKET_ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO($parser) {
	echo "$parser->packet_desc Result=".$parser->word()."\n";
	echo "$parser->nl ItemID=".$parser->word()."\n";
	echo "$parser->nl Price=".$parser->long()."\n";
}
...
function PACKET_CZ_REQ_APPLY_BARGAIN_SALE_ITEM($parser) {
	...
	echo "$parser->nl ItemID=".$parser->word()."\n";
	echo "$parser->nl Count=".$parser->long()."\n";
	echo "$parser->nl StartDate=".$parser->long()."\n";
	echo "$parser->nl SellingTime=".$parser->byte()."\n";
}
...
function PACKET_ZC_NOTIFY_BARGAIN_SALE_SELLING($parser) {
	echo "$parser->packet_desc ItemID=".$parser->word()."\n";
	echo "$parser->nl TabCode=".$parser->word()."\n";
}
